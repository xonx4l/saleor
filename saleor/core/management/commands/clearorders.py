...
class Command(BaseCommand):
    ...
    def delete_checkouts(self):
        pre_reservations = PreorderReservation.objects.all()
        pre_reservations._raw_delete(pre_reservations.db)
    ...
    def delete_orders(self):
        ...
        pre_allocations = PreorderAllocation.objects.all()
        pre_allocations._raw_delete(pre_allocations.db)
